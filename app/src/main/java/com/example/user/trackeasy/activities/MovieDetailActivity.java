...
import com.example.user.trackeasy.adapters.MovieBriefsSmallAdapter;
import com.example.user.trackeasy.adapters.MovieCastsAdapter;
...
import com.example.user.trackeasy.network.movies.Genre;
import com.example.user.trackeasy.network.movies.Movie;
import com.example.user.trackeasy.network.movies.MovieBrief;
import com.example.user.trackeasy.network.movies.MovieCastBrief;

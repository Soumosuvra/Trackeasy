package com.example.user.trackeasy.adapters;
...
import com.example.user.trackeasy.activities.MovieDetailActivity;
import com.example.user.trackeasy.activities.PersonDetailActivity;
import com.example.user.trackeasy.activities.TVShowDetailActivity;
import com.example.user.trackeasy.network.search.SearchResult;

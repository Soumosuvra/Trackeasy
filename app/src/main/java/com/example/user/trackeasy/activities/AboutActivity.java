...
public class AboutActivity extends AppCompatActivity {
    ...
    private CardView sourceCardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sourceCardView = (CardView) findViewById(R.id.card_view_source);

        openFrameLayout = (FrameLayout) findViewById(R.id.frame_layout_open_source_licenses);
    ...
    private void loadActivity() {
        ...
        feedbackImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                feedbackIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"soumo.suvra.naskar.5@gmail.com"});

package com.example.user.trackeasy.network;

import com.example.user.trackeasy.network.movies.Movie;
import com.example.user.trackeasy.network.movies.MovieCastsOfPersonResponse;
import com.example.user.trackeasy.network.movies.MovieCreditsResponse;
import com.example.user.trackeasy.network.movies.NowShowingMoviesResponse;
import com.example.user.trackeasy.network.movies.PopularMoviesResponse;
import com.example.user.trackeasy.network.movies.SimilarMoviesResponse;
import com.example.user.trackeasy.network.movies.TopRatedMoviesResponse;
import com.example.user.trackeasy.network.movies.UpcomingMoviesResponse;
import com.example.user.trackeasy.network.people.Person;
import com.example.user.trackeasy.network.tvshows.AiringTodayTVShowsResponse;
import com.example.user.trackeasy.network.tvshows.OnTheAirTVShowsResponse;
import com.example.user.trackeasy.network.tvshows.PopularTVShowsResponse;
import com.example.user.trackeasy.network.tvshows.SimilarTVShowsResponse;
import com.example.user.trackeasy.network.tvshows.TVCastsOfPersonResponse;
import com.example.user.trackeasy.network.tvshows.TVShow;
import com.example.user.trackeasy.network.tvshows.TVShowCreditsResponse;
import com.example.user.trackeasy.network.tvshows.TopRatedTVShowsResponse;
import com.example.user.trackeasy.network.videos.VideosResponse;
...
public interface ApiInterface {
    ...
    Call<com.example.user.trackeasy.network.movies.GenresList> getMovieGenresList(@Query("api_key") String apiKey);
    ...
    @GET("genre/tv/list")
    Call<com.example.user.trackeasy.network.tvshows.GenresList> getTVShowGenresList(@Query("api_key") String apiKey);

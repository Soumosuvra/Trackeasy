...
import com.example.user.trackeasy.adapters.TVShowBriefsSmallAdapter;
import com.example.user.trackeasy.adapters.TVShowCastAdapter;
import com.example.user.trackeasy.adapters.VideoAdapter;
import com.example.user.trackeasy.broadcastreceivers.ConnectivityBroadcastReceiver;
import com.example.user.trackeasy.network.ApiClient;
import com.example.user.trackeasy.network.ApiInterface;
import com.example.user.trackeasy.network.tvshows.Genre;
import com.example.user.trackeasy.network.tvshows.Network;
...
import com.example.user.trackeasy.network.tvshows.TVShowBrief;
import com.example.user.trackeasy.network.tvshows.TVShowCastBrief;
import com.example.user.trackeasy.network.tvshows.TVShowCreditsResponse;
import com.example.user.trackeasy.network.videos.Video;
import com.example.user.trackeasy.network.videos.VideosResponse;
import com.example.user.trackeasy.utils.Constant;
import com.example.user.trackeasy.utils.Favourite;

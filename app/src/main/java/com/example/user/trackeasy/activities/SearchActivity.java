...
import com.example.user.trackeasy.adapters.SearchResultsAdapter;
import com.example.user.trackeasy.network.search.SearchAsyncTaskLoader;
import com.example.user.trackeasy.network.search.SearchResponse;
